  ...
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`}>
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full md:-mt-[20px] -mt-[12px] -top-32"
      >
        <div className="absolute w-full h-[300px] hero-gradient rounded-tl-[140px] -top-[30px]" />
        <img
          src="/cover.png"
          alt="cover"
          className="w-full sm:h-[400px] h-[100px] object-cover rounded-tl-[140px] relative"
        />
        <a href="#explore">
          <div className="w-full flex justify-end sm:-mt-[70px] -mt-[50px] pr-[40px]">
            <img
              src="/stamp.png"
              alt="stamp"
              className="sm:w-[155px] w-[100px] sm:h-[155px] h-[100px] z-10 object-contain"
            />
          </div>
        </a>
      </motion.div>
